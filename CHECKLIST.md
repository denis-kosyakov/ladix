...
Используйте этот список перед релизом.
...
- [x] В `SPEC.md` описаны области видимости. — `SPEC.md:251`
- [x] В `SPEC.md` описаны ошибки. — `SPEC.md:607`
- [x] В `SPEC.md` описаны ограничения языка. — `SPEC.md:591`
