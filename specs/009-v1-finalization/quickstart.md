...
содержит заявленный факт; убедиться, что тексты пунктов чеклиста не изменены (diff
против исходного чеклиста — только чекбоксы и сноски).
✅ SC-003.
...
```
Свести: каждый из 9 пунктов функционального контракта §1–§9 закрыт доказательством файл:строка или
...
| 6 | US6 | функциональный контракт §1–§9 закрыт; дерево чистое | SC-008 |
