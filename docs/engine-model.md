...
провален (D-14), канон §13 в stderr, exit 1. То есть путь провала инстанса от внешнего вызова
