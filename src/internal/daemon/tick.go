...
// drainEvents — фаза 1 (события, FR-016/017). TODO(слайс 4): разбор очереди FIFO,
// матч событие-триггеров по имени, инжект «событие», MarkEventProcessed после тела.
// Сейчас заглушка: присутствует и вызывается в правильном порядке, тел не исполняет.
func (d *Daemon) drainEvents() {}

// checkSchedules — фаза 3 (расписание, FR-011…013). TODO(слайс 4): каждые/в "ЧЧ:ММ"
// с durable trigger_state и календарным сдвигом. Сейчас заглушка: присутствует и
// вызывается в правильном порядке, тел не исполняет.
