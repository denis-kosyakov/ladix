...
// не регистрируются — фантомный каскад исключён (FR-025/FR-026). Оговорка: гарантия
// держится лишь для НЕЗАВИСИМЫХ ошибок на РАЗНЫХ строках; ведущее ключевое слово
// (если/пока/вернуть/…) в позиции выражения на одной/смежной строке (напр.
// «пусть x = если») даёт 2–4 диагностики на одну сломанную конструкцию — дизайн
// точек возобновления sync-lead (D-R8; SPEC §12 «Диагностика/восстановление
// парсера»).
