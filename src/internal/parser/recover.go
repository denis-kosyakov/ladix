...
// фантомный каскад исключён (но лишь для ошибок на РАЗНЫХ строках; ведущее KW в
// позиции выражения на одной/смежной строке — sync-lead D-R8 — даёт 2–4 диагностики
// на одну сломанную конструкцию, см. SPEC §12 «Диагностика/восстановление парсера»).
