...
// keywords — 35 ключевых слов Ladix → их виды токенов (SPEC §2, data-model §5.3).
...
// reservedWords — 11 зарезервированных слов (FR-013): токена НЕ дают, дают
// LexError L-11. Защита совместимости для будущих версий Ladix. (010-A1
// §SC-D-RESERVE: `тип` РАЗрезервировано — теперь ключевое слово KW_TYPE.)
var reservedWords = map[string]bool{
	"параллельно": true, "модуль": true, "импорт": true, "экспорт": true,
	"повторить": true, "выбрать": true, "пытаться": true,
